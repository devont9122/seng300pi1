...
public class ProductDatabaseTest {
	...
	public void testRegisterProduct() {
		...
		BarcodedProduct product = new BarcodedProduct(barcode, "Test product", new BigDecimal(10.95));
	...
	public void testRegisterMultipleProducts() {
		...
		for(int i = 0; i < NUM_PRODUCTS; i++) {
			...
			products[i] = new BarcodedProduct(bc, "Test product", new BigDecimal(1.00));
		}
		
		db.RegisterProducts(products);
		
		assertEquals("Wow", NUM_PRODUCTS, db.getNumberOfProducts());
